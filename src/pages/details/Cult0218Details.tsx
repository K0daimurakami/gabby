...
const Cult0218Details: React.FC = () => {
  ...
  // テンプレート一覧
    const templates = [
      {
        messageText: "今日の16時から開催の会議で終了の10分前にネクストアクションは決まっていない場合、確認連絡をしてほしい。",
        icon: <SendIcon fontSize="large" />,
        type: "message",
      },
      {
        messageText: "先週の会議で、終了後期限までにネクストアクションが実施されているか確認をしてほしい。",
        icon: <SendIcon fontSize="large" />,
        type: "message",
      },
    ];
...
export default Cult0218Details;
