...
const Cult0217Details: React.FC = () => {
  ...
  // テンプレート一覧
    const templates = [
      {
        messageText: "Aさんに対しWebエンジニアとしての技術力向上を目的とした1on1を組んで。",
        icon: <SendIcon fontSize="large" />,
        type: "message",
      },
      {
        messageText: "業務内容ではなく性格をベースに管理職同士での1on1を組んでほしい",
        icon: <SendIcon fontSize="large" />,
        type: "message",
      },
    ];
...
export default Cult0217Details;
